...
//   setPlayerData((prev) => ({
//     // if (playerData.lvl > 20 || playerData.lvl < 1 ) {
...
// <button onClick={() => togglePopupScroll('classType')} className='bg-slate-100 p-1 '>change</button>
//         </div>



// <div className="flex p-4 rounded justify-between bg-slate-300">
//   <div className="w-[50%]">
//     <p>Level</p>
//     <p>{playerData.lvl}</p>
//   </div>
//     <div className='flex items-center'>
//       <button onClick={() => changeLevel(1)} className="bg-green-300 p-1">^</button>
//       <button onClick={() => changeLevel(-1)} className="bg-rose-300 p-1">v</button>
//     </div>
